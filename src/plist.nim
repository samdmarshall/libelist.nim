...
proc plist_new_dict*(): plist_t {.importc: "plist_new_dict".}
## *
...
proc plist_new_array*(): plist_t {.importc: "plist_new_array".}
## *
...
proc plist_new_string*(val: cstring): plist_t {.importc: "plist_new_string".}
## *
...
proc plist_new_bool*(val: uint8): plist_t {.importc: "plist_new_bool".}
## *
...
proc plist_new_uint*(val: uint64): plist_t {.importc: "plist_new_uint".}
## *
...
proc plist_new_real*(val: cdouble): plist_t {.importc: "plist_new_real".}
## *
...
proc plist_new_data*(val: cstring, length: uint64): plist_t {.importc: "plist_new_data".}
## *
...
proc plist_new_date*(sec: int32, usec: int32): plist_t {.importc: "plist_new_date".}
## *
...
proc plist_new_uid*(val: uint64): plist_t {.importc: "plist_new_uid".}
## *
...
proc plist_free*(plist: plist_t) {.importc: "plist_free".}
## *
...
proc plist_copy*(node: plist_t): plist_t {.importc: "plist_copy".}
## *******************************************
##                                           *
##             Array functions               *
##                                           *
...
proc plist_array_get_size*(node: plist_t): uint32 {.importc: "plist_array_get_size".}
## *
...
proc plist_array_get_item*(node: plist_t; n: uint32): plist_t {.importc: "plist_array_get_item".}
## *
...
proc plist_array_get_item_index*(node: plist_t): uint32 {.importc: "plist_array_get_item_index".}
## *
...
proc plist_array_set_item*(node: plist_t, item: plist_t, n: uint32) {.importc: "plist_array_set_item".}
## *
...
proc plist_array_append_item*(node: plist_t, item: plist_t) {.importc: "plist_array_append_item".}
## *
...
proc plist_array_insert_item*(node: plist_t, item: plist_t; n: uint32) {.importc: "plist_array_insert_item".}
## *
...
proc plist_array_remove_item*(node: plist_t, n: uint32) {.importc: "plist_array_remove_item".}
## *******************************************
##                                           *
...
proc plist_dict_get_size*(node: plist_t): uint32 {.importc: "plist_dict_get_size".}
## *
...
proc plist_dict_new_iter*(node: plist_t, iter: ptr plist_dict_iter) {.importc: "plist_dict_new_iter".}
## *
...
proc plist_dict_next_item*(node: plist_t, iter: plist_dict_iter, key: ptr cstring, val: ptr plist_t) {.importc: "plist_dict_next_item".}
## *
...
proc plist_dict_get_item_key*(node: plist_t, key: ptr cstring) {.importc: "plist_dict_get_item_key".}
## *
...
proc plist_dict_get_item*(node: plist_t, key: cstring): plist_t {.importc: "plist_dict_get_item".}
## *
...
proc plist_dict_set_item*(node: plist_t, key: cstring, item: plist_t) {.importc: "plist_dict_set_item".}
## *
...
proc plist_dict_remove_item*(node: plist_t, key: cstring) {.importc: "plist_dict_remove_item".}
## *
...
proc plist_dict_merge*(target: ptr plist_t, source: plist_t) {.importc: "plist_dict_merge".}
## *******************************************
##                                           *
##                 Getters                   *
##                                           *
...
proc plist_get_parent*(node: plist_t): plist_t {.importc: "plist_get_parent".}
## *
...
proc plist_get_node_type*(node: plist_t): plist_type {.importc: "plist_get_node_type".}
## *
...
proc plist_get_key_val*(node: plist_t, val: ptr cstring) {.importc: "plist_get_key_val".}
## *
...
proc plist_get_string_val*(node: plist_t, val: ptr cstring) {.importc: "plist_get_string_val".}
## *
...
proc plist_get_bool_val*(node: plist_t, val: ptr uint8) {.importc: "plist_get_bool_val".}
## *
...
proc plist_get_uint_val*(node: plist_t, val: ptr uint64) {.importc: "plist_get_uint_val".}
## *
...
proc plist_get_real_val*(node: plist_t, val: ptr cdouble) {.importc: "plist_get_real_val".}
## *
...
proc plist_get_data_val*(node: plist_t, val: ptr cstring, length: ptr uint64) {.importc: "plist_get_data_val".}
## *
...
proc plist_get_date_val*(node: plist_t, sec: ptr int32, usec: ptr int32) {.importc: "plist_get_date_val".}
## *
...
proc plist_get_uid_val*(node: plist_t, val: ptr uint64) {.importc: "plist_get_uid_val".}
## *******************************************
##                                           *
##                 Setters                   *
##                                           *
...
proc plist_set_key_val*(node: plist_t, val: cstring) {.importc: "plist_set_key_val".}
## *
##  Set the value of a node.
...
proc plist_set_string_val*(node: plist_t, val: cstring) {.importc: "plist_set_string_val".}
## *
##  Set the value of a node.
...
proc plist_set_bool_val*(node: plist_t, val: uint8) {.importc: "plist_set_bool_val".}
## *
##  Set the value of a node.
...
proc plist_set_uint_val*(node: plist_t, val: uint64) {.importc: "plist_set_uint_val".}
## *
##  Set the value of a node.
...
proc plist_set_real_val*(node: plist_t, val: cdouble) {.importc: "plist_set_real_val".}
## *
##  Set the value of a node.
...
proc plist_set_data_val*(node: plist_t, val: cstring, length: uint64) {.importc: "plist_set_data_val".}
## *
##  Set the value of a node.
...
proc plist_set_date_val*(node: plist_t, sec: int32, usec: int32) {.importc: "plist_set_date_val".}
## *
##  Set the value of a node.
...
proc plist_set_uid_val*(node: plist_t, val: uint64) {.importc: "plist_set_uid_val".}
## *******************************************
##                                           *
##             Import & Export               *
##                                           *
...
proc plist_to_xml*(plist: plist_t, plist_xml: pointer, length: ptr uint32) {.importc: "plist_to_xml".}
## *
...
proc plist_to_bin*(plist: plist_t, plist_bin: pointer, length: ptr uint32) {.importc: "plist_to_bin".}
## *
...
proc plist_from_xml*(plist_xml: pointer, length: uint32, plist: ptr plist_t) {.importc: "plist_from_xml".}
## *
...
proc plist_from_bin*(plist_bin: pointer, length: uint32, plist: ptr plist_t) {.importc: "plist_from_bin".}
## *******************************************
##                                           *
##                  Utils                    *
##                                           *
...
proc plist_access_path*(plist: plist_t, length: uint32): plist_t {.varargs, importc: "plist_access_path".}
## *
...
proc plist_access_pathv*(plist: plist_t, length: uint32; v: varargs): plist_t {.importc: "plist_access_pathv".}
## *
...
proc plist_compare_node_value*(node_l: plist_t, node_r: plist_t): char {.importc: "plist_compare_node_value".}
## @}
